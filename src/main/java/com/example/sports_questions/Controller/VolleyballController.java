...
public class VolleyballController {
    ...
    public VolleyballController(SportsAiService sportsAiService) {
        this.sportsAiService = sportsAiService;
    }

    @GetMapping
    public List<Map<String, String>> getQuestions(@RequestParam(name = "prompt", defaultValue = "") String prompt) {
        return sportsAiService.getQuestions("volleyball", prompt);
    }
}
